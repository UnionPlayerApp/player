...
import 'package:union_player_app/utils/widgets/snapping_sheet_lib/sheet_content_wrapper.dart';
import 'package:union_player_app/utils/widgets/snapping_sheet_lib/sheet_position_data.dart';
import 'package:union_player_app/utils/widgets/snapping_sheet_lib/snapping_calculator.dart';
...
import 'above_sheet_size_calculator.dart';
import 'below_sheet_size_calculator.dart';
import 'on_drag_wrapper.dart';
...
///////--->
  @override
  // _SnappingSheetState createState() => _SnappingSheetState(initialSnappingPosition?.getPosition());
  _SnappingSheetState createState() => _SnappingSheetState(initialSnappingPosition, sheetSize, grabbingHeight);
////////<---
}
...
////////--->
  _SnappingSheetState(SnappingPosition? initialSnappingPosition, double _sheetSize, double _grabbingHeight){
    print("######_SnappingSheetState()######");
    if (initialSnappingPosition != null) {
      this._currentPositionPrivate = initialSnappingPosition.getPositionInPixels(
        _sheetSize,
        _grabbingHeight,
      );
    };
...
//////<---
  ...
  TickerFuture _animateToPosition(SnappingPosition snappingPosition) {
    ...
    var endPosition = snappingPosition.getPositionInPixels( //TODO
      sheetSize,
      widget.grabbingHeight,
    );
...
///////---->
    ...
    print("_currentPositionPrivate = $_currentPositionPrivate");
            ...
            children: [
              ...
              SheetContentWrapper(
                ...
                sizeCalculator: AboveSheetSizeCalculator(
                  ...
                  currentPosition: _currentPosition,
                  maxHeight: sheetSize, //TODO maybe bannerSize + widget.grabbingHeight
                  grabbingHeight: widget.grabbingHeight,
                ),
                sheetData: widget.sheetAbove,
              ),
