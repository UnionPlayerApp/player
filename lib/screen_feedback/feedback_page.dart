...
class FeedbackPageState extends State {
    ...
    showModalBottomSheet(
        ...
        builder: (context) {
          ...
          return StatefulBuilder(
            ...
            return IndexedStack(index: indexedStackPosition, children: <Widget>[
              WebView(
                key: _webViewKey,
                initialUrl: _url,
  ...
  Future<String> _getUrlFromAssets() async {
    String fileText =
        await rootBundle.loadString('assets/about_us_page/test_page.html');
                  ...
                  child: Row(
                    ...
                    children: [
                      TextButton(
                        ...
                        child: Text(
                            translate(StringKeys.aboutButtonText, context)),
                      ),
                      Padding(
                          ...
                          child: ElevatedButton(
                            ...
                            child: Text(
                                translate(StringKeys.sendButtonText, context)),
                          )),
                    ],
                  ),
                ),
